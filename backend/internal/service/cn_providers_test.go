...
func TestGetAPIProtocol(t *testing.T) {
	...
	require.Equal(t, APIProtocolZcode, mk(PlatformZhipu, APIProtocolZcode).GetAPIProtocol(), "zhipu 支持 zcode 渠道档")
	require.Equal(t, APIProtocolChatCompletions, mk(PlatformKimi, APIProtocolZcode).GetAPIProtocol(), "zcode 仅 zhipu 可用")
